...
export default ({
  heading = "Better Call Rani.",
  description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.",
  imageSrc = heroImg,
  imageDecoratorBlob = true,
  primaryButtonUrl = "https://bit.ly/Aquino-Sales-Advocacia-WhatsApp",
  ...
  testimonial = {
    ...
    customerName: "Ranier Aquino Sales",
    customerCompany: "Aquino Sales Advocacia",
  },
}) => {
